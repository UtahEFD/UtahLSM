...
class MOST : public Surface {
    ...
    public:
         ...
         */
        MOST(const int sfc_model) : Surface(sfc_model){}
         ...
         */
        virtual double fm(const double z1, const double z0, const double obukL);
         ...
         */
        virtual double fh(const double z1, const double z0, const double obukL);
