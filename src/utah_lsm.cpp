...
double UtahLSM :: computeSEB(double sfc_T) {
    ...
    //std::cout<<"Int Depth: "<<int_depth<<"  Min Flux: "<<min_sflux<<std::endl;
...
void UtahLSM :: solveSMB() {
    ...
    double mois_1 = soil_q[0] - 0.1;
    double mois_2 = soil_T[0] + 0.1;
